...
-- 資料庫： `3s_co_ltd`
--
CREATE DATABASE IF NOT EXISTS `3s_co_ltd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `3s_co_ltd`;
...
-- 資料庫： `220ct cw`
--
CREATE DATABASE IF NOT EXISTS `220ct cw` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `220ct cw`;
...
INSERT INTO `agency` (`Agency_No`, `Lead_Agency`) VALUES
(32, 'Roskosmos'),
(167, 'NASA'),
(178, 'JAXA'),
(526, 'ESA');
...
INSERT INTO `equipment` (`NO.`, `Equipment`, `Qty`, `Item_Weight`, `Total_Weight`) VALUES
(1, 'Potable water dispenser', 2, '100kg', '200kg'),
(2, 'Flexible air duct', 6, '0.5kg', '3kg'),
(3, 'Small storage Rack', 4, '2kg', '8kg'),
(4, 'Bio filter', 6, '0.2kg', '1.2kg'),
(5, 'Small storage Rack', 3, '2kg', '6kg'),
(6, 'Battery pack', 2, '5kg', '10kg'),
(7, 'Urine transfer tubing', 2, '1.5kg', '3kg'),
(8, 'O2 scrubber', 1, '50kg', '50kg'),
(9, 'Small storage', 1, '2kg', '2kg'),
(10, 'Flexible', 2, '0.5kg', '1kg');
...
CREATE TABLE `missions` (
  `Mission_No` varchar(255) NOT NULL,
  `Agency_No` int(11) NOT NULL,
...
INSERT INTO `missions` (`Mission_No`, `Agency_No`, `Country`, `Mission_Date`) VALUES
('ABC-1234', 32, 'Russia', '2014-04-16'),
('ABC-2237', 178, 'Japan', '2013-12-14'),
('ABC-2356', 167, 'USA', '2014-02-12'),
('ABC-3664', 526, 'EU', '2014-01-16');
...
INSERT INTO `missions_e` (`Mission_No`, `Equipment`) VALUES
('ABC-2237', 'Potable water dispenser'),
('ABC-2237', 'Flexible air duct'),
('ABC-2237', 'Small storage Rack'),
('ABC-3664', 'Bio filter'),
('ABC-2356', 'Small storage Rack'),
('ABC-2356', 'Battery pack'),
('ABC-2356', 'Urine transfer tubing'),
('ABC-2356', 'O2 scrubber'),
('ABC-1234', 'Small storage'),
('ABC-1234', 'Flexible');
...
CREATE TABLE `original data` (
  ...
  `Equipment` varchar(255) NOT NULL,
  `Qty` int(11) NOT NULL,
  `Item Weight` varchar(255) NOT NULL,
  `Total Weight` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- 傾印資料表的資料 `original data`
--

INSERT INTO `original data` (`NO.`, `Mission_No`, `Agency_No`, `Lead_Agency`, `Country`, `Mission_date`, `Equipment`, `Qty`, `Item Weight`, `Total Weight`) VALUES
(1, 'ABC-2237', 178, 'JAXA', 'Japan', '2013-12-14', 'Potable water dispenser', 2, '100kg', '200kg'),
(2, 'ABC-2237', 178, 'JAXA', 'Japan', '2013-12-14', 'Flexible air duct', 6, '0.5kg', '3kg'),
(3, 'ABC-2237', 178, 'JAXA', 'Japan', '2013-12-14', 'Small storage Rack', 4, '2kg', '8kg'),
(4, 'ABC-3664', 526, 'ESA', 'EU', '2014-01-16', 'Bio filter', 6, '0.2kg', '1.2kg'),
(5, 'ABC-2356', 167, 'NASA', 'USA', '2014-02-12', 'Small storage Rack', 3, '2kg', '6kg'),
(6, 'ABC-2356', 167, 'NASA', 'USA', '2014-02-12', 'Battery pack', 2, '5kg', '10kg'),
(7, 'ABC-2356', 167, 'NASA', 'USA', '2014-02-12', 'Urine transfer tubing', 2, '1.5kg', '3kg'),
(8, 'ABC-2356', 167, 'NASA', 'USA', '2014-02-12', 'O2 scrubber', 1, '50kg', '50kg'),
(9, 'ABC-1234', 32, 'Roskosmos', 'Russia', '2014-04-16', 'Small storage', 1, '2kg', '2kg'),
(10, 'ABC-1234', 32, 'Roskosmos', 'Russia', '2014-04-16', 'Flexible', 2, '0.5kg', '1kg');
...
-- 資料表索引 `missions_e`
--
ALTER TABLE `missions_e`
  ADD KEY `Mission_No` (`Mission_No`);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `original data`
--
ALTER TABLE `original data`
...
--
ALTER TABLE `missions_e`
  ADD CONSTRAINT `missions_e_ibfk_1` FOREIGN KEY (`Mission_No`) REFERENCES `missions` (`Mission_No`);
--
-- 資料庫： `assignment`
--
...
(1, 'admin001', 'z', 'z', 'F', 12345944, 'abc@hotmail.com', '2021-11-11 22:53:57'),
(2, 'admin002', 'admin002', 'admin002', 'M', 84932742, 'admin@hMail.com', '2021-11-11 22:53:57'),
(3, 'admin003', 'admin003', 'admin003', 'M', 12387432, 'testingA@Admin.com', '2021-11-11 22:55:49'),
(4, 'admin004', 'admin004', 'admin004', 'F', 94382324, 'admin04@gg.com', '2021-11-11 22:55:49');
...
CREATE TABLE `customer` (
  ...
  `status` enum('verifying','verified','suspended') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `customer` (`customer_id`, `name`, `username`, `pw`, `gender`, `phone`, `email`, `address`, `created_dt`, `status`) VALUES
(1, 'chiu mimii', 'customer', 'customer', 'M', 11111111, 'abc@umail.com', 'abc building 100/F Flat Z', '2021-11-11 23:28:00', 'verified'),
(2, 'jayden hui', 'aaaaaaaa', 'aaaaaaaa', 'M', 77777777, 'jaydenhui@gmail.com', 'testing', '2020-10-28 00:00:00', 'verified'),
(3, 'lam mimi', 'lammimi', 'fdksjlfjk', 'F', 33333333, 'lammimi@email.com', 'mimi building', '2020-10-30 00:00:00', 'verified'),
(4, 'lau mimi', 'laumimi', 'ksjdfkdf', 'F', 22222222, 'laumimi@imail.com', 'laumimi building', '2020-10-30 00:00:00', 'verified'),
(5, 'liu mimi', 'liumimi', 'kffak333333', 'M', 44444444, 'liumimi@qmail.com', 'liumimi building', '2020-10-30 00:00:00', 'verified'),
(6, 'pui mimi', 'b', 'b', 'M', 55555555, 'puimimi@omail.com', 'puimimi building', '2020-10-30 00:00:00', 'verifying'),
(7, 'bui mimi', 'buimimi', 'buimimimi', 'F', 87654321, 'buimimi@yo.com', 'buimimi building', '2020-11-02 16:30:23', 'verified'),
(8, 'oo mimi', 'fakfadjk', 'jdgdhkgdskh', 'M', 25936252, 'jsghhgrk@gshd.jsg', 'hskgdhsdgk', '2020-11-03 17:27:15', 'verified'),
(9, 'dfdf mimi', 'shdgkgadg', 'kdajghkr', 'M', 29745445, 'dsjggeeg@gshd.jsg', 'kadjghr', '2020-11-03 17:27:20', 'verified'),
(10, 'fufu mimi', 'aejhfjg', 'aeghkdeeg', 'F', 13874606, 'krgh@ksgjrg.egh', 'ldsjghrgrg', '2020-11-03 17:33:39', 'verified'),
(11, 'chiu mimi', 'srjghrjgr', 'grgjrkgadf', 'M', 91935359, 'krjghrg@jjhdg.eghe', 'ejhege', '2020-11-03 17:36:28', 'verified'),
(12, 'dfkdkfndf', 'rgjrhgjrg', 'egjegjee', 'M', 10840933, 'djfe@jeg.cmk', 'dfjef', '2020-11-03 17:54:00', 'verified'),
(13, 'chiuff', 'ehfeug', 'djvhkjdgn', 'F', 29486043, 'djjghdg@rg.rg', 'a', '2020-11-04 15:33:19', 'verified'),
(14, 'chiu oo', 'lrgjhrg', 'wlrghgeeg', 'M', 85932339, 'jgr@gj.f', 'wjeglhwg', '2020-11-04 15:55:35', 'verified'),
(15, 'banned', 'suspended', 'suspended', 'M', 83153555, 'djvhdv@g.g', 'buildingd', '2020-11-04 15:56:08', 'suspended'),
(16, 'chiu pipi', 'adjkhdg', 'aekjdgrg', 'M', 28974544, 'rjghg@rh.ge', 'ekhg', '2020-11-04 16:08:17', 'verified'),
(17, 'mimio', 'adljfhdg', 'adljghadlg', 'M', 29744499, 'adjghdg@ef.fe', 'adkjghdg', '2020-11-04 16:09:25', 'verified'),
(18, 'alm didi', 'efefefef', 'efefefefef', 'M', 92387535, 'djfhdf@rg.gr', '', '2020-11-04 16:14:14', 'verified'),
(19, 'pui oep', 'adjfkhdf', 'efhefefef', 'M', 28937535, 'dkjfhd@g.gr', 'adljdlgg', '2020-11-04 16:15:09', 'verified'),
(20, 'chiu mimi', 'a', 'a', 'M', 83275922, 'adkjhd@fe.f', '', '2020-11-04 16:16:45', 'verified'),
(21, 'chiu kjkj', 'adjfhdg', 'djkghdgdg', 'F', 47545464, 'dlkkjgdg@fg.gf', 'dgdgsg', '2020-11-04 16:22:30', 'verified'),
(22, 'pinky', 'sdglhdg', 'dsljghdgdg', 'F', 24857923, 'dlgh@f.fe', 'aejkhdg', '2020-11-04 16:23:50', 'verified'),
(23, 'rringer', 'hihiihihih', 'hihihihihiih', 'F', 24578495, 'djhdg@f.ef', 'hihihihi building', '2020-11-04 16:31:22', 'verified'),
(24, 'chiu mimi', 'ldhglegge', 'lheldgdgdg', 'F', 92857924, 'djghdlg@ge.g', 'adljgdg', '2020-11-04 16:32:10', 'verified'),
(25, 'chiu mimi', 'lsdhldg', 'dlshgldgdg', 'M', 98434969, 'dsljhgd@g.ggg', 'ddfdfdfdffd', '2020-11-04 16:45:40', 'verified'),
(26, 'verifying', 'verifying', 'verifying', 'M', 48545459, 'dakjghdkg@g.g', '', '2020-11-04 16:46:48', 'verifying'),
(27, 'afsfas', 'asfafsasff', 'afsasfasf', 'F', 64646644, 'elg@g.g', 'gg', '2020-11-07 01:00:13', 'verifying'),
(28, 'delete me thank you', 'deleteme', 'deleteme', 'F', 23923999, 'grjggr@gggg.g', '', '2020-11-07 01:13:08', 'verifying'),
(29, 'twenty nine', 'adhhdhd', 'fhfhfhfhfhf', 'F', 54757575, 'fsgfh@g.g', '', '2020-11-07 01:15:24', 'verifying'),
(30, 'thirty', 'adhhdhd', 'fhfhfhfhfhf', 'F', 54757575, 'fsgfh@g.g', '', '2020-11-07 01:15:24', 'verifying'),
(31, 'thirty one', 'jdgjdjdjdk', 'kdhgkhuwifhf', 'F', 35235856, 'ewgkdg@g.g', '', '2020-11-07 01:28:46', 'verifying'),
(32, 'thirty two', 'bjbjbkjbgj', 'kjbbkjbkjbkj', 'F', 76775777, 'gfhyt@g.g', '', '2020-11-07 01:40:38', 'verifying'),
(33, 'thirty three', 'lkdsklgjskldg', 'kljskdlgjksd', 'F', 29292900, 'lsjdhgldsg@g.g', 'llsdgkls', '2020-11-11 16:23:08', 'verifying'),
(34, 'thirty four', 'thirtyfour', 'thirtyfour', 'F', 93939393, 'thirtyfour@g.g', 'ggg', '2020-11-14 18:46:47', 'verifying'),
(35, 'thirty five', 'thirtyfive', 'thirtyfive', 'F', 39393939, 'thirtyfive@gggg.g', 'dddd', '2020-11-14 18:47:59', 'verifying'),
(36, 'abc', 'abc123', 'ab123123', 'M', 12341234, 'abc@mail.com', '', '2021-10-16 13:58:36', 'verifying'),
(37, 'asfassf asf', 'fsdgdgdg', 'dsgsdgdgdg', 'M', 12251244, 'aafasf@ffff.cca', 'llfgf', '2021-11-25 23:13:58', 'verifying'),
(38, 'af', 'affffqqq', 'afasfefeff', 'M', 13851510, 'gjgj@g.g', 'gr', '2021-11-25 23:28:53', 'verifying'),
(39, 'afasf', 'sfasfsaf', 'affdfdfdf', 'F', 46341355, 'bjenny122@gmail.com', 'g', '2021-11-25 23:35:25', 'verifying');
...
CREATE TABLE `items` (
  ...
  `item_gender` enum('men','women','kids','unisex') NOT NULL,
  `item_category` set('footwear','apparel','accessories') NOT NULL,
  `item_brand` enum('Adidas','Champion','New Balance','Reebok','The North Face') NOT NULL,
  `item_name` varchar(30) NOT NULL,
  `item_activity` set('Casual','Running','Yoga','Football','Basketball','Badminton','Table Tennis','Tennis','Swimming','Outdoor / Hiking') NOT NULL,
  `item_function` set('Stay Warm','Moisture Absorbing/ Wicking / Quick Dry','Waterproof','Water Repellent','Breathable','UV Protection','Grippy','Slip-Resistant','Cushioning','Energy return','Lightweight') NOT NULL,
  `item_description` varchar(50) NOT NULL,
  `item_features` text NOT NULL,
  `item_color` varchar(20) NOT NULL,
  `item_price` float(7,2) NOT NULL,
  `item_percentOff` int(3) NOT NULL,
  `item_Price_after_discount` float(7,2) NOT NULL,
  `item_uploadDate` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `items` (`item_no`, `item_gender`, `item_category`, `item_brand`, `item_name`, `item_activity`, `item_function`, `item_description`, `item_features`, `item_color`, `item_price`, `item_percentOff`, `item_Price_after_discount`, `item_uploadDate`) VALUES
(1, 'men', 'footwear', 'Adidas', 'GT-1000 9 GTX', 'Casual,Running', 'Stay Warm', 'it is a pair of shoes ', '- with air packs', 'black ', 3000.00, 10, 2700.00, '2021-10-08 23:55:12'),
(2, 'men', 'footwear', 'Champion', 'GTB-1300', 'Casual,Yoga', 'UV Protection', 'kjdshfkjsgf', '-djofkejrgf\r\n-fdskjhgkser', 'red', 300.00, 5, 285.00, '2021-11-08 23:57:27'),
(3, 'men', 'footwear', 'New Balance', 'ABC shoes', 'Running,Outdoor / Hiking', 'Waterproof,Breathable', 'sdjnfklsajnfs', '-vfdsgdsfg\r\n-jkshfij', 'purple', 500.00, 10, 450.00, '2021-11-09 00:03:10'),
(4, 'men', 'apparel', 'Reebok', 'v-shirt', 'Casual,Swimming', 'Breathable,Lightweight', 'sdjnfksdjfnksjfns', '-fgfdsg\r\n-dfkjgnkjds', 'yellow', 299.00, 30, 209.30, '2021-11-09 00:05:47'),
(5, 'men', 'accessories', 'The North Face', '745 tennis racket', 'Casual,Tennis', 'Moisture Absorbing/ Wicking / Quick Dry,Grippy,Cushioning', 'gfjgdhgfhjgf', '-vfdjghdsfj\r\n-ckjhfkjs', 'blue', 432.00, 0, 432.00, '2021-11-09 00:05:47'),
(6, 'women', 'apparel', 'Reebok', 'WV-shirt', 'Casual,Yoga', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Lightweight', 'It is a shirt', '- Quick dry\r\n- light-blue', 'light-blue', 438.00, 15, 372.30, '2021-11-09 00:09:03'),
(7, 'women', 'apparel', 'Adidas', 'WM round123', 'Basketball', 'Moisture Absorbing/ Wicking / Quick Dry,Water Repellent,Cushioning', 'fhdsijfheds', '-dfjkvndskf\r\n-nfdkjgnkfj', 'yellow', 743.00, 0, 743.00, '2021-11-09 00:09:03'),
(8, 'women', 'accessories', 'New Balance', '45 football bag', 'Casual,Football,Badminton', 'Lightweight', 'gnfksjdghdsjkfg', '-ckejfnewkj\r\n-ejfgnjeh', 'dark red', 399.00, 25, 299.25, '2021-11-09 00:11:23'),
(9, 'women', 'footwear', 'Adidas', 'Gorden sports shoes', 'Running,Football', 'Moisture Absorbing/ Wicking / Quick Dry,Water Repellent', 'khghghjg', '-fsdjfgherjk\r\n-efijghejr', 'green', 789.00, 5, 749.55, '2021-11-09 00:11:23'),
(10, 'women', 'accessories', 'Reebok', 'B basketball bag', 'Basketball,Badminton', 'Waterproof,Grippy', 'kfhdsjhgidsj', '-fjknkdsd\r\n-dfnjkdfjndj', 'pink', 834.00, 2, 817.32, '2021-11-09 00:13:59'),
(11, 'kids', 'apparel', 'The North Face', 'k-12 shorts', 'Casual,Table Tennis,Tennis', 'Moisture Absorbing/ Wicking / Quick Dry,UV Protection', 'It is a pair of shorts', '-Quick dry\r\n-light-green', 'light-green', 284.00, 0, 284.00, '2021-11-09 00:13:59'),
(12, 'kids', 'footwear', 'Reebok', 'k-11 sport shoes', 'Casual,Running', 'Water Repellent,Breathable,UV Protection', 'vbsijfhbjdzfx', '-jofggeoj\r\n-dkfnksfj', 'light-blue', 422.00, 3, 409.34, '2021-11-09 00:16:29'),
(13, 'kids', 'accessories', 'Champion', 'K-53 badminton racket', 'Badminton,Tennis', 'Waterproof', 'kjbdskajfbskjf', '-ejkfnskdjf\r\n-dkjsfnvdksjf', 'orange', 888.00, 3, 861.36, '2021-11-09 00:16:29'),
(14, 'kids', 'apparel', 'The North Face', 'k-822 shorts', 'Casual,Running', 'Cushioning,Lightweight', 'bfnejrgerjskd', '-ejkfnekf\r\n-ejfgnhjeksf', 'white', 854.00, 0, 854.00, '2021-11-09 00:17:43'),
(15, 'kids', 'apparel', 'Champion', 'k-432 jacket', 'Casual,Basketball,Badminton', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof', 'jfenrjgfdshxznfkgjer', '-ckfgndskgnj\r\n-dsnkgnfdskg', 'brown', 289.00, 3, 280.33, '2021-11-09 00:19:13'),
(16, 'unisex', 'accessories', 'The North Face', 'u-123 socks', 'Casual,Yoga', 'Breathable,Slip-Resistant', 'It is a pair of socks', '-red\r\n-available for Yoga', 'red', 732.00, 5, 695.40, '2021-11-09 00:23:53'),
(17, 'unisex', 'accessories', 'New Balance', 'Sereno socks', 'Casual,Outdoor / Hiking', 'UV Protection,Lightweight', 'nfdbgjkdbfjskg', '-ejkfnekj\r\n-esojefnj', 'orange', 274.00, 3, 265.78, '2021-11-09 00:23:53'),
(18, 'unisex', 'apparel', 'Champion', 'u 23 jacket', 'Casual,Yoga', 'Moisture Absorbing/ Wicking / Quick Dry', 'jfnbsjgfhesj', '-fdokghjfefsjoik\r\n-fenkgjherk', 'yellow', 832.00, 2, 815.36, '2021-11-09 00:26:59'),
(19, 'unisex', 'footwear', 'New Balance', 'u239 hiking boots', 'Casual,Running,Outdoor / Hiking', 'Waterproof,Slip-Resistant,Lightweight', 'rydjrfhdgf', '-fdsjfhk\r\n-fdhgdk', 'green', 842.00, 3, 816.74, '2021-11-09 00:26:59'),
(20, 'unisex', 'apparel', 'New Balance', 'universe 123 jacket', 'Casual,Tennis', 'Moisture Absorbing/ Wicking / Quick Dry,Breathable,UV Protection,Grippy', 'bvkjdfsgbdjkxzfh', '-fdkgnreok\r\n-efnjkgnerj', 'light-blue', 410.00, 2, 401.80, '2021-11-09 00:28:35'),
(21, 'men', 'footwear', 'New Balance', '123 Trail Running shoes', 'Casual,Running,Outdoor / Hiking', 'Water Repellent,Grippy,Slip-Resistant', 'jgfnfdsklj', '-jkhdjkfhgkdsjfhsjk\r\n\r\n-jfhsadjfh', 'blue', 832.00, 3, 807.04, '2021-11-09 13:33:23'),
(22, 'men', 'footwear', 'Adidas', 'peter 2908', 'Casual,Running', 'Waterproof,Lightweight', 'bfkjsadhfcksd', '-gdfhgfds\r\n-fkjhdsk', 'orange', 888.00, 5, 843.60, '2021-11-09 13:33:23'),
(23, 'men', 'footwear', 'New Balance', 'Court Speed  Men Tennis shoes', 'Tennis', 'Breathable,Grippy', 'vbfdjgshfvkfdksj', '-fkdwfnk\r\n-skfnokds', 'black', 459.00, 0, 459.00, '2021-11-09 13:37:51'),
(24, 'men', 'apparel', 'New Balance', 'JG123 Sweatshirts', 'Casual', 'Breathable', 'mndskfnk', '-kedfhkj\r\n-fjherjkfh', 'dark-blue', 299.00, 0, 299.00, '2021-11-09 13:37:51'),
(25, 'men', 'apparel', 'Champion', 'UA Piped Hoodie', 'Casual', 'Stay Warm', 'jsebfjdsjn', '-ksfjendfsij\r\n-fkejdfnjcd', 'red', 449.00, 2, 440.02, '2021-11-09 13:54:49'),
(26, 'women', 'apparel', 'Champion', 'AJ pants', 'Casual,Yoga', 'Breathable,Lightweight', 'nfkmd', '-gjierjgk\r\n-ferjhgj', 'black', 200.00, 10, 180.00, '2021-11-09 13:54:49'),
(27, 'women', 'apparel', 'New Balance', 'Future Icons Sweatshirt', 'Casual,Yoga', 'Moisture Absorbing/ Wicking / Quick Dry', 'bvfjsdkgbdsajkbf', '-sjdbfjkd\r\n-fdjkffds', 'dark green', 845.00, 3, 819.65, '2021-11-09 16:16:16'),
(28, 'women', 'accessories', 'The North Face', 'nice sock', 'Casual,Football,Basketball,Badminton,Table Tennis,Tennis', 'Breathable,Energy return', 'bawhefgdusjhfjdskcxjz', '-ffjwedksmxbcnjdm\r\n-ufjhkdsxurjfkdcmx', 'pink', 832.00, 0, 832.00, '2021-11-09 16:24:58'),
(29, 'women', 'footwear', 'Adidas', 'Speedgoat4', 'Casual,Running', 'Waterproof,Breathable', 'fjhmfhjn', '-kjvgkjh\r\n-jlgjkhkj', 'green', 555.00, 3, 538.35, '2021-11-09 16:24:58'),
(30, 'women', 'accessories', 'Reebok', 'light bag73', 'Casual', 'Cushioning', 'ghdrgfhfg', '-gdrfghgf\r\n-hgfbhfvg', 'blue', 1243.00, 0, 1243.00, '2021-11-09 17:07:47'),
(31, 'kids', 'apparel', 'Champion', 'crew123', 'Casual', 'Lightweight', 'ngjdsfxhjk', '-fjdknjfrdn\r\n-fjkdcjfd', 'red', 239.00, 3, 231.83, '2021-11-09 17:13:04'),
(32, 'kids', 'apparel', 'Adidas', 'Rival Hoodies', 'Casual,Outdoor / Hiking', 'Moisture Absorbing/ Wicking / Quick Dry', 'jfdhsjhvd', '-kgjrefdmcx\r\n-rfgdjhkvcx', 'orange', 399.00, 0, 399.00, '2021-11-09 17:13:04'),
(33, 'kids', 'apparel', 'New Balance', 'Big Sleeve T-shirt', 'Casual', '', 'jrkahgfdszvcsfdyguhcxzj', '-hrtjfkdgcnugrkhfdjcvm\r\n-kjfdghvhgfdjmnvc', 'pink', 999.00, 4, 959.04, '2021-11-09 17:16:26'),
(34, 'kids', 'accessories', 'Champion', 'Silicone cap', 'Casual,Swimming', '', 'rjkfdnscfdjksnm', '-regjkmfdjfdkm\r\n-fidkcfjkdmc', 'blue', 99.00, 5, 94.05, '2021-11-09 17:16:26'),
(35, 'kids', 'footwear', 'New Balance', 'Pop roller shoes', 'Casual,Outdoor / Hiking', 'Breathable,Cushioning', 'fkjshdciuertgdshfx', '-hfdjcmfbvdnkcxzjm\r\n-rfdiujkcxmjfkdnvmc', 'yellow', 699.00, 0, 699.00, '2021-11-09 17:17:46'),
(36, 'unisex', 'apparel', 'Champion', 'Japan Hoodie', 'Casual', '', 'fhgdscxjehgrsukjfdnmc', '-hrefjdbkvnmcjkfdmc\r\n-fhdjvcxndbjhfvncx', 'grey', 988.00, 30, 691.60, '2021-11-09 23:17:08'),
(37, 'unisex', 'accessories', 'The North Face', 'virtual Mirror', 'Swimming', 'Waterproof', 'rtjkgifdbvgeifjdk', '-ekrfdknjdf\r\n-rfnjdkcmxkjfndm', 'blue', 699.00, 0, 699.00, '2021-11-09 23:24:58'),
(38, 'unisex', 'footwear', 'Adidas', 'HIgh 36 boots', 'Running,Outdoor / Hiking', 'Water Repellent,Breathable,Grippy,Slip-Resistant,Cushioning,Lightweight', 'rtuhigkvfdjcfdhvjcxn', '-gerhfdjksc\r\n-ghfbjvdckx', 'red', 1599.00, 25, 1199.25, '2021-11-09 23:24:58'),
(39, 'unisex', 'accessories', 'New Balance', 'sweet towel', 'Casual,Yoga', 'Waterproof', 'thgfdjcnhdgfsbjkz', '-hgfjdks\r\n-fhdjknsfd', 'blue', 299.00, 5, 284.05, '2021-11-09 23:24:58'),
(40, 'unisex', 'apparel', 'The North Face', 'Edition 1 jacket', 'Casual,Running', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Breathable,UV Protection', 'hgrtjkfdngfshbjdn', '-bfjvmdnc,\r\n-bhfjvdnkcmx', 'pink', 899.00, 30, 629.30, '2021-11-09 23:24:58'),
(41, 'women', 'apparel', 'The North Face', 'Testing 1', 'Casual,Running,Yoga,Football,Basketball,Badminton,Table Tennis,Tennis,Swimming,Outdoor / Hiking', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Water Repellent,Breathable,UV Protection,Grippy,Slip-Resistant,Cushioning,Energy return,Lightweight', '-testing data', '-for testing\r\n-for testing', 'red', 745.00, 2, 730.10, '2021-11-12 18:55:56'),
(42, 'kids', 'footwear', 'Adidas', 'Testing 2', 'Casual,Running,Yoga,Football,Basketball,Badminton,Table Tennis,Tennis,Swimming,Outdoor / Hiking', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Water Repellent,Breathable,UV Protection,Grippy,Slip-Resistant,Cushioning,Energy return,Lightweight', '-for Testing', '-for Testing\r\n-for Testing', 'blue', 800.00, 5, 760.00, '2021-11-12 18:55:56'),
(43, 'men', 'accessories', 'Reebok', 'Testing 3', 'Casual,Running,Yoga,Football,Basketball,Badminton,Table Tennis,Tennis,Swimming,Outdoor / Hiking', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Water Repellent,Breathable,UV Protection,Grippy,Slip-Resistant,Cushioning,Energy return,Lightweight', '-Testing', '-for Testing\r\n-for Testing', 'green', 1213.00, 0, 1213.00, '2021-11-12 18:59:48'),
(44, 'unisex', 'accessories', 'Adidas', 'Testing 4', 'Casual,Running,Yoga,Football,Basketball,Badminton,Table Tennis,Tennis,Swimming,Outdoor / Hiking', 'Moisture Absorbing/ Wicking / Quick Dry,Waterproof,Water Repellent,Breathable,UV Protection,Grippy,Slip-Resistant,Cushioning,Energy return,Lightweight', 'Testing', '-for testing\r\n-for testing', 'yellow', 600.00, 10, 540.00, '2021-11-12 18:59:48');

--
-- 觸發器 `items`
--
DELIMITER $$
CREATE TRIGGER `UpdatePrice` BEFORE UPDATE ON `items` FOR EACH ROW set New.item_Price_after_discount=New.item_Price*(1-new.item_percentOff/100)
$$
DELIMITER ;
...
CREATE TABLE `mycart` (
  ...
  `customer_id` int(11) NOT NULL,
  `item_no` int(10) NOT NULL,
  `size` enum('XS','S','M','L','XL','EU-19','EU-20','EU-21','EU-22','EU-23','EU-24','EU-25','EU-26','EU-27','EU-28','EU-29','EU-30','EU-31','EU-32','EU-33','EU-34','EU-35','EU-36','EU-37','EU-38','EU-39','EU-40','EU-41','EU-42','EU-43','EU-44','EU-45','EU-46','Free') NOT NULL,
  `quantity` int(10) NOT NULL,
  `item_Price_after_discount` float(7,2) NOT NULL,
...
INSERT INTO `mycart` (`no`, `customer_id`, `item_no`, `size`, `quantity`, `item_Price_after_discount`, `Total_price`, `create_time`) VALUES
(1, 3, 33, 'S', 2, 959.04, 1918.08, '2021-11-11 22:42:51'),
(2, 3, 2, 'EU-39', 3, 285.00, 45.00, '2021-11-11 22:42:51'),
(3, 3, 34, 'Free', 2, 94.05, 188.10, '2021-11-11 22:42:51'),
(4, 1, 26, 'XL', 3, 180.00, 540.00, '2021-11-14 18:22:02'),
(5, 1, 26, 'S', 2, 180.00, 360.00, '2021-11-14 18:22:02'),
(8, 1, 34, 'Free', 3, 94.05, 282.15, '2021-11-16 03:17:46'),
(9, 6, 41, 'S', 2, 730.10, 29.80, '2021-11-22 17:40:26'),
(10, 6, 15, 'S', 1, 280.33, 280.33, '2021-11-22 17:40:34'),
(13, 1, 44, 'Free', 2, 540.00, 120.00, '2021-11-23 23:55:49'),
(14, 20, 41, 'S', 0, 730.10, 0.00, '2021-11-24 23:35:50'),
(15, 20, 28, 'Free', 1, 1213.00, 832.00, '2021-11-26 18:34:42'),
(16, 20, 24, 'M', 0, 1213.00, 0.00, '2021-11-26 19:41:09'),
(17, 20, 25, 'M', 1, 440.02, 440.02, '2021-11-27 00:28:50'),
(18, 1, 30, 'Free', 5, 1213.00, 6215.00, '2021-11-27 01:56:05'),
(19, 1, 41, 'Free', 5, 730.10, 74.50, '2021-11-27 01:56:11'),
(20, 1, 41, 'S', 0, 730.10, 0.00, '2021-11-27 01:58:44');

--
-- 觸發器 `mycart`
--
DELIMITER $$
CREATE TRIGGER `onInsert` BEFORE INSERT ON `mycart` FOR EACH ROW SET NEW.`Total_price` = NEW.`quantity` * NEW.`item_Price_after_discount`
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `onUpdate` BEFORE UPDATE ON `mycart` FOR EACH ROW SET NEW.`Total_price` = NEW.`quantity` * NEW.`item_Price_after_discount`
$$
DELIMITER ;
...
INSERT INTO `stock` (`no`, `item_no`, `size`, `stock_level`) VALUES
(1, 1, 'EU-40', 0),
(2, 2, 'EU-46', 89),
(5, 5, 'Free', 100),
(6, 6, 'S', 20),
...
INSERT INTO `transaction` (`no`, `Trans_no`, `customer_id`, `item_no`, `size`, `quantity`, `item_Price_after_discount`, `Total_price`, `card_holder_name`, `credit_card_no`, `Address`, `status`, `transaction_time`) VALUES
(1, 1, 20, 36, 'S', 2, 691.60, 1383.20, 'asd', '1234123412341234', 'Flat A, 3/F, BLK 1, ABC Building,Hong Kong', 'received', '2021-11-11 18:11:59'),
(2, 1, 20, 37, 'Free', 1, 699.00, 699.00, 'asd', '1234123412341234', 'Flat A, 3/F, BLK 1, ABC Building,Hong Kong', 'received', '2021-11-11 18:11:59'),
(3, 2, 3, 33, 'S', 2, 959.04, 1918.08, 'asdasd', '4321432143214321', 'Flat C, 4/F, BB Building, Kowloon ', 'delivering', '2021-11-11 22:42:51'),
(4, 2, 3, 2, 'EU-39', 3, 949.99, 2849.97, 'asdasd', '4321432143214321', 'Flat C, 4/F, BB Building, Kowloon ', 'delivering', '2021-11-11 22:42:51'),
(5, 2, 3, 34, 'Free', 2, 94.05, 188.10, 'asdasd', '4321432143214321', 'Flat C, 4/F, BB Building, Kowloon ', 'delivering', '2021-11-11 22:42:51'),
(6, 3, 7, 32, 'S', 2, 959.04, 1918.08, 'hhaaa', '4321432143214322', 'abc road', 'delivering', '2021-11-16 02:19:04'),
(7, 3, 7, 12, 'EU-40', 2, 409.34, 818.68, 'hhaaa', '4321432143214322', 'abc Road', 'delivering', '2021-11-16 02:19:04'),
(8, 4, 21, 31, 'M', 2, 691.60, 1383.20, 'gg eree', '4321432143214323', 'ABCnfjksd', 'preparing', '2021-11-16 02:22:30'),
(9, 4, 21, 20, 'L', 1, 401.80, 401.80, 'gg eree', '4321432143214323', 'gkejhfdcsxzjhgefbdkcnms,', 'preparing', '2021-11-16 02:22:30'),
(10, 5, 8, 5, 'Free', 1, 432.00, 432.00, 'asfasf fff', '4321432143214324', 'gfedvcgfdv', 'delivering', '2021-11-16 02:22:30'),
(11, 5, 8, 24, 'XS', 1, 299.00, 299.00, 'asfasf fff', '4321432143214324', 'gerfdsrgefds', 'delivering', '2021-11-16 02:22:30'),
(12, 5, 8, 26, 'S', 2, 180.00, 360.00, 'asfasf fff', '4321432143214324', 'jmhgnfbvjhtgfv', 'delivering', '2021-11-16 02:22:30'),
(13, 6, 20, 36, 'XL', 10, 691.60, 6916.00, 'hahgaer ggga', '4321432143214325', 'asdas', 'received', '2021-11-22 17:06:17'),
(14, 6, 20, 36, 'S', 10, 691.60, 6916.00, 'hahgaer ggga', '4321432143214325', 'asdas', 'received', '2021-11-22 17:06:17'),
(15, 7, 1, 22, 'EU-46', 1, 843.60, 843.60, 'gqqv f', '4321432143214326', 'abc building 100/F Flat Z', 'pending', '2021-11-24 22:10:45'),
(16, 7, 1, 22, 'EU-45', 2, 843.60, 1687.20, 'gqqv f', '4321432143214326', 'abc building 100/F Flat Z', 'pending', '2021-11-24 22:10:45'),
(17, 8, 20, 25, 'S', 2, 440.02, 880.04, 'fff', '1234123412341234', 'a', 'delivering', '2021-11-24 22:58:56'),
(18, 8, 20, 30, 'Free', 1, 1243.00, 1243.00, 'fff', '1234123412341234', 'a', 'delivering', '2021-11-24 22:58:56'),
(19, 8, 20, 37, 'Free', 1, 699.00, 699.00, 'fff', '1234123412341234', 'a', 'delivering', '2021-11-24 22:58:56'),
(20, 9, 20, 25, 'M', 3, 440.02, 1320.06, 'a', '1234123412341234', 'a', 'pending', '2021-11-27 00:28:19'),
(21, 10, 1, 42, 'EU-42', 5, 760.00, 3800.00, 'Chu Mimi', '1234234534564567', 'abc building 100/F Flat Z', 'preparing', '2021-11-27 03:04:12'),
(22, 11, 1, 42, 'EU-40', 2, 760.00, 1520.00, 'Peter', '8742874283428932', 'abc building 100/F Flat Z', 'received', '2021-11-27 04:58:56');
...
INSERT INTO `wish_list` (`no`, `customer_id`, `item_no`, `size`, `quantity`, `item_Price_after_discount`, `Total_price`, `create_time`) VALUES
(1, 3, 33, 'S', 1, 959.04, 959.04, '2021-11-11 22:42:51'),
(2, 3, 2, 'EU-39', 1, 285.00, 15.00, '2021-11-11 22:42:51'),
(3, 3, 34, 'Free', 1, 94.05, 94.05, '2021-11-11 22:42:51'),
(4, 20, 30, 'Free', 1, 1213.00, 1243.00, '2021-11-26 19:39:41'),
(6, 20, 42, 'EU-39', 1, 760.00, 760.00, '2021-11-26 22:55:44'),
(7, 1, 30, 'Free', 5, 1213.00, 6215.00, '2021-11-27 01:56:05'),
(8, 1, 41, 'Free', 5, 730.10, 74.50, '2021-11-27 01:56:12'),
(9, 1, 42, 'EU-40', 1, 760.00, 760.00, '2021-11-27 01:58:15'),
(10, 1, 41, 'S', 0, 730.10, 0.00, '2021-11-27 03:09:23');

--
-- 觸發器 `wish_list`
--
DELIMITER $$
CREATE TRIGGER `onUpdateWishList` BEFORE UPDATE ON `wish_list` FOR EACH ROW SET NEW.`Total_price` = NEW.`quantity` * NEW.`item_Price_after_discount`
$$
DELIMITER ;
...
ALTER TABLE `items`
  ...
  ADD KEY `item_gender` (`item_gender`),
  ADD KEY `item_Price_after_discount` (`item_Price_after_discount`);
...
ALTER TABLE `mycart`
  ...
  ADD KEY `transaction_ibfk_1` (`item_no`),
  ADD KEY `size` (`size`),
  ADD KEY `Price` (`item_Price_after_discount`);
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `items`
--
ALTER TABLE `items`
  MODIFY `item_no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `mycart`
--
ALTER TABLE `mycart`
...
--
ALTER TABLE `stock`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
...
--
ALTER TABLE `mycart`
  ADD CONSTRAINT `mycart_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `mycart_ibfk_2` FOREIGN KEY (`item_no`) REFERENCES `items` (`item_no`),
  ADD CONSTRAINT `mycart_ibfk_3` FOREIGN KEY (`item_Price_after_discount`) REFERENCES `items` (`item_Price_after_discount`) ON UPDATE CASCADE,
  ADD CONSTRAINT `mycart_ibfk_4` FOREIGN KEY (`size`) REFERENCES `stock` (`size`);

--
-- 資料表的限制式 `stock`
--
ALTER TABLE `stock`
  ADD CONSTRAINT `stock_ibfk_1` FOREIGN KEY (`item_no`) REFERENCES `items` (`item_no`);

--
-- 資料表的限制式 `transaction`
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `transaction_ibfk_2` FOREIGN KEY (`item_no`) REFERENCES `items` (`item_no`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `transaction_ibfk_4` FOREIGN KEY (`size`) REFERENCES `stock` (`size`) ON UPDATE NO ACTION;

--
-- 資料表的限制式 `wish_list`
--
ALTER TABLE `wish_list`
  ADD CONSTRAINT `wish_list_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `wish_list_ibfk_2` FOREIGN KEY (`item_no`) REFERENCES `items` (`item_no`),
  ADD CONSTRAINT `wish_list_ibfk_3` FOREIGN KEY (`item_Price_after_discount`) REFERENCES `items` (`item_Price_after_discount`) ON UPDATE CASCADE,
  ADD CONSTRAINT `wish_list_ibfk_4` FOREIGN KEY (`size`) REFERENCES `stock` (`size`);
--
-- 資料庫： `online_shopping`
--
...
(6, 'root', 'database', 'assignment', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"structure_or_data_forced\":\"0\",\"table_select[]\":[\"admin_login\",\"customer_login\",\"customer_order\",\"inventory\"],\"table_structure[]\":[\"admin_login\",\"customer_login\",\"customer_order\",\"inventory\"],\"table_data[]\":[\"admin_login\",\"customer_login\",\"customer_order\",\"inventory\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@DATABASE@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"@TABLE@ 資料表結構\",\"latex_structure_continued_caption\":\"@TABLE@ 資料表結構 (續)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"@TABLE@ 表的內容\",\"latex_data_continued_caption\":\"@TABLE@ 表的內容 (續)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"structure_and_data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"structure_and_data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_procedure_function\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"xml_structure_or_data\":\"data\",\"xml_export_events\":\"something\",\"xml_export_functions\":\"something\",\"xml_export_procedures\":\"something\",\"xml_export_tables\":\"something\",\"xml_export_triggers\":\"something\",\"xml_export_views\":\"something\",\"xml_export_contents\":\"something\",\"yaml_structure_or_data\":\"data\",\"\":null,\"lock_tables\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_create_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_view_current_user\":null,\"sql_or_replace_view\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"online_shopping\",\"table\":\"building_material\"},{\"db\":\"3s_co_ltd\",\"table\":\"building_material\"},{\"db\":\"online_shopping\",\"table\":\"bm_quantity\"},{\"db\":\"3s_co_ltd\",\"table\":\"bm_quantity\"},{\"db\":\"online_shopping\",\"table\":\"admin\"},{\"db\":\"online_shopping\",\"table\":\"provider\"},{\"db\":\"online_shopping\",\"table\":\"customer\"},{\"db\":\"online_shopping\",\"table\":\"cases\"},{\"db\":\"online_shopping\",\"table\":\"cases_application\"},{\"db\":\"marathon\",\"table\":\"stock\"}]');
...
--
-- 傾印資料表的資料 `pma__relation`
--

INSERT INTO `pma__relation` (`master_db`, `master_table`, `master_field`, `foreign_db`, `foreign_table`, `foreign_field`) VALUES
('online_shopping', 'building_material', 'case_id', 'online_shopping', 'cases', 'case_id'),
('online_shopping', 'building_material', 'item', 'online_shopping', 'bm_quantity', 'item'),
('online_shopping', 'building_material', 'price', 'online_shopping', 'bm_quantity', 'price');
...
('online_shopping', 'bm_quantity', 'price'),
('online_shopping', 'building_material', 'price');
...
('root', '220ct cw', 'missions_e', '{\"sorted_col\":\"`missions_e`.`Mission_No` ASC\"}', '2021-11-09 16:02:06'),
('root', 'marathon', 'mycart', '{\"sorted_col\":\"`mycart`.`customer_id` ASC\"}', '2021-11-26 17:57:31'),
('root', 'marathon', 'stock', '{\"sorted_col\":\"`item_no` ASC\"}', '2021-11-26 19:10:10'),
('root', 'marathon', 'transaction', '{\"sorted_col\":\"`Trans_no`  DESC\"}', '2021-11-26 21:13:04'),
('root', 'online_shopping', 'admin', '{\"sorted_col\":\"`admin`.`admin_id` ASC\"}', '2022-02-19 16:05:58'),
('root', 'online_shopping', 'building_material', '{\"sorted_col\":\"`building_material`.`no`  DESC\"}', '2022-03-11 09:14:01'),
('root', 'online_shopping', 'cases', '{\"sorted_col\":\"`cases`.`case_id` ASC\"}', '2022-02-16 15:24:46'),
('root', 'online_shopping', 'cases_application', '{\"sorted_col\":\"`cases_application`.`apply_dt` DESC\"}', '2022-02-16 15:24:19'),
('root', 'online_shopping', 'customer', '{\"sorted_col\":\"`customer`.`customer_id` ASC\"}', '2022-02-19 16:05:07');
...
('root', '2022-03-22 09:19:37', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\"}');
